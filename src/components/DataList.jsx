...
const DataList = ({ initialFoods }) => {
  ...
  if (loading)
    return (
      <tr>
        <td colSpan={3}>
          <div className="text-sm py-3 flex justify-center">
            <svg
              aria-hidden="true"
              className="w-5 h-5 text-gray-200 animate-spin dark:text-gray-300 fill-blue-600"
              viewBox="0 0 100 101"
              fill="none"
